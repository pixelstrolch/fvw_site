...
const Newsletter = () => (
  <div className={style.newsletter}>
    <form action="https://familienverein-wahlen.us20.list-manage.com/subscribe/post?u=b253eee6416ea9da8c26e4732&amp;id=a800f2e22b" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
